Public Class FormUsuario
    ...
    Private Sub BtnGuardar_Click(sender As Object, e As EventArgs) Handles BtnGuardar.Click
        ...
        If TxtNombre.Text.Trim() <> "" AndAlso TxtClave.Text.Trim() <> "" Then
            Try
                Dim usuario As New UsuarioEntidad
            ...
            End Try
        Else
            MsgBox("Por favor, complete todos los campos antes de guardar el registro.", MsgBoxStyle.Critical, "Clinica")
        End If
    ...
    Private Sub FormUsuario_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        DGVusuario.EditMode = DataGridViewEditMode.EditProgrammatically
    ...
    Private Sub BtnEditar_Click(sender As Object, e As EventArgs) Handles BtnEditar.Click
        ...
        If DGVusuario.SelectedRows.Count > 0 Then
            ...
            If Not String.IsNullOrWhiteSpace(TxtNombre.Text) AndAlso Not String.IsNullOrWhiteSpace(TxtClave.Text) Then
                usuario.NombreUsuario = TxtNombre.Text
                usuario.ClaveUsuario = TxtClave.Text
                ...
                End Try
            Else
                MsgBox("Los campos de entrada no pueden estar vacíos.", MsgBoxStyle.Exclamation, "Clinica")
            End If
        Else
