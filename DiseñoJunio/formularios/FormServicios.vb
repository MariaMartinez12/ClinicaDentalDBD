...
Public Class FormServicios
    ...
    Private Sub BtnGuardar_Click(sender As Object, e As EventArgs) Handles BtnGuardar.Click
        ...
        If DGVservicio.SelectedRows.Count > 0 Then
            ...
            ' Validar campo de nombre no vacío
            If Not String.IsNullOrWhiteSpace(TxtNombre.Text) Then
                servicio.NombreServicio = TxtNombre.Text

                Dim costo As Decimal
                ' Validar campo de costo numérico
                If Decimal.TryParse(TxtCosto.Text, costo) Then
                    ...
                    End Try
                Else
                    MsgBox("El campo de costo debe ser un número.", MsgBoxStyle.Exclamation, "Clinica")
                End If
            Else
                MsgBox("El campo de nombre no puede estar vacío.", MsgBoxStyle.Exclamation, "Clinica")
            End If
    ...
    Private Sub FormServicios_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        DGVservicio.AllowUserToDeleteRows = False
        DGVservicio.EditMode = DataGridViewEditMode.EditProgrammatically
