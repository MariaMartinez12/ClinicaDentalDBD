...
'QUE NO ME APAREZCAN LOS QUE DELETE ES TRUE'
...
Public Class ConsultaDao
    ...
    Public Function MostrarRegistros() As DataSet 'EDITAR'
        ...
        Try
            Dim tsql As String = "SELECT Consulta.consultaID, Consulta.cantServicios, Consulta.fechaConsulta, Consulta.pacienteID, Consulta.servicioID, Servicio.nombreServicio as 'nomServicio' FROM Consulta INNER JOIN Servicio ON Consulta.servicioID = Servicio.ServicioID WHERE Consulta.deleted = 0"
